...
Ugotovimo, da je največja uvoznica iz ZDA Kanada, nato Mehika, veliko manj Kitajska in druge države. Zanimivo je, da je v letu 2009 mogoče opaziti znatno zmanjšanje izvoza in uvoza, nakar se pa v letu 2010 spet začne povečevati.

Nadaljeval sem z risanjem zemljevidov. Najprej sem uvozil zemljevid in spremenil imena držav, ki niso bila enaka na zemljevidu in v podatkih, nato pa sem narisal zemljevid za izvoz v letu 2015 in nato še zemljevid za uvoz v letu 2015. 
Zemljevid uvoza ZDA v letu 2015 sledi:

```{r zem2, echo=FALSE, fig.align='center'}
...
```{r zem3, echo=FALSE, fig.align='center'}
...
Ugotovil sem, da je največja razlika v trgovinski bilanci z Kitajsko, saj tja ZDA ne izvozi veliko v primerjavi s tem koliko uvozi. Videti je mogoče, da ima ZDA z večino držav sveta pozitivno trgovinsko bilanco.

***
# Zaključek
Pri obravnavi trgovanja ZDA sem veliko izvedel o njegovih največjih izvoznikih in uvoznikih ter kako se spreminja uvoz in izvoz skozi čas, ter zraven tudi kakšna je trgovinska bilanca. Vemo da je ZDA velesila in da so nekatere države odvisne od njihovega izvoza in uvoza, zraven pa se izkaže, da njihovo trgovanje obsega skorajda ves svet.
